    ...
    public class PropertyProfile : Profile
    {
        public PropertyProfile()
        {
            ...
            CreateMap<Property, PropertyDto>()
                ...
                .ForMember(dest => dest.Year, opt => opt.MapFrom(src => src.Year))
                .ForMember(dest => dest.Owner, opt => opt.MapFrom(src => src.Owner != null ? new OwnerDto { IdOwner = src.Owner.IdOwner, OwnerName = src.Owner.Name, OwnerPhoto = src.Owner.Photo != null ? src.Owner.Photo : null } : null))
                ...
                .ForMember(dest => dest.IsActive, opt => opt.MapFrom(src => src.IsActive)); // ? Agregado
